...
/// </summary>
public class L_TextMeshProUGui : MonoBehaviour
{
    public int IdOfTextEntry;
    public TextMeshProUGUI LabelToChangeTextOf;
    ...
    private void Start()
    {
        ...
        {
            LabelToChangeTextOf = gameObject.GetComponent<TextMeshProUGUI>(); //Try to find a Text class
            if (LabelToChangeTextOf == null)
            {
