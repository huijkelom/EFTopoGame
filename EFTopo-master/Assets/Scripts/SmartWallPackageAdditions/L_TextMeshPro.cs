...
/// </summary>
public class L_TextMeshPro : MonoBehaviour
{
    public int IdOfTextEntry;
    public TextMeshPro LabelToChangeTextOf;
    ...
    private void Start()
    {
        ...
        {
            LabelToChangeTextOf = gameObject.GetComponent<TextMeshPro>(); //Try to find a Text class
            if (LabelToChangeTextOf == null)
            {
